(function() {
    const API_KEY = '022a2e86954e2bf55a1a18fc981dbc4d';
    const FORM_ID = '241013857416150';
    const BASE_URL = 'https://hipaa-api.jotform.com/v1';
    ...
    function createUI() {
        ...
        return { filterInput, submissionsList };
    }
    ...
    async function getSubmissions() {
        const url = `${BASE_URL}/form/${FORM_ID}/submissions?apiKey=${API_KEY}&limit=500&orderby=created_at`;
    ...
    function displaySubmissions(submissions, listElement) {
        ...
        submissions.forEach(submission => {
            ...
            li.addEventListener('click', () => autofillForm(submission));
    ...
    // Autofill form function (your existing autofillForm function goes here)
    ...
    // Helper functions (fillInputByName, selectRadioByName, etc.) go here
